...
import { CheckRecoveryOptionsQuery, CheckRecoveryOptionsResultDto } from '../../../../../api-services/user/user-api.model';
...
export class EnterEmailStepComponent extends BaseComponent {
  ...
  onSubmit(): void {
    ...
    this.userApi.checkRecoveryOptions(recoveryPayload).subscribe({
      ...
      error: (error) => {
        this.stopLoading("Failed to check recovery options. Please try again.");
      }
