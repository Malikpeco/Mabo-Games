...
public sealed class UploadAchievementImageCommandValidator : AbstractValidator<UploadAchievementImageCommand>
{
    private const long MaxFileSize = 10 * 1024 * 1024;

    public UploadAchievementImageCommandValidator()
    {
        RuleFor(x => x.File)
            .NotNull()
