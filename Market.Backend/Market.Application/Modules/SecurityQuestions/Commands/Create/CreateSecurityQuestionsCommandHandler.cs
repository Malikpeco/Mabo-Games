...
{
    public sealed class CreateSecurityQuestionsCommandHandler(IAppDbContext context, IAppCurrentUser appCurrentUser) 
        : IRequestHandler<CreateSecurityQuestionsCommand, CreateSecurityQuestionResultDto>
        
    {
        public async Task<CreateSecurityQuestionResultDto> Handle(CreateSecurityQuestionsCommand request, CancellationToken cancellationToken)
        {
